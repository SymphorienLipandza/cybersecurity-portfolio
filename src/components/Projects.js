        ...
        <section id="projects" className="section">
            ...
            <div className="project-grid">
                <div className="project">
                    ...
                    <a href="https://github.com/symphorienlipandza/elderee-backend" target="_blank" rel="noopener noreferrer" className="project-link">View Details</a>
                </div>
                <div className="project">
                    ...
                    <a href="https://github.com/symphorienlipandza/cyber-forensics" target="_blank" rel="noopener noreferrer" className="project-link">View Details</a>
                </div>
                <div className="project">
                    ...
                    <a href="https://github.com/symphorienlipandza/blood-bank-app" target="_blank" rel="noopener noreferrer" className="project-link">View Details</a>
                </div>
                <div className="project">
                    ...
                    <a href="https://github.com/symphorienlipandza/data-analytics" target="_blank" rel="noopener noreferrer" className="project-link">View Details</a>
                </div>
            </div>
        </section>
    );
