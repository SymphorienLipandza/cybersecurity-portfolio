        ...
        <section id="projects" className="section">
            ...
            <div className="project-grid">
                <div className="project">
                    <img src="https://via.placeholder.com/300x200" alt="Secure Backend Development for Elderee" />
                ...
                <div className="project">
                    <img src="https://via.placeholder.com/300x200" alt="Cybersecurity and Digital Forensics Internship" />
                ...
                <div className="project">
                    <img src="https://via.placeholder.com/300x200" alt="Blood Bank Application Development" />
                ...
                <div className="project">
                    <img src="https://via.placeholder.com/300x200" alt="Data Analytics and Visualization" />
